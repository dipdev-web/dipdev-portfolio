      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
        {projects.map((p, i) => (
          <motion.a
            ...
            className="group perspective-[1200px] block"
          >
            <div
              className="relative rounded-2xl overflow-hidden border border-white/10 bg-neutral-900 transform transition duration-500 group-hover:rotate-x-6 group-hover:rotate-y-[-6deg] group-hover:scale-[1.03]"
            ...
            >
              <Image
                ...
                width={800}
                height={500}
                className="w-full h-[320px] object-contain object-center group-hover:scale-110 transition duration-700 p-2"
              />
